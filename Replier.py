...
def ChatBot(Text):
    ...
    if "hi" in Text:
        print("Hello")
        Speak("Hello Jyoti Mam")

    elif "Hello jyoti what is your age" in Text:
        print("i am a robo not human.")
        Speak("i am a robo not human.")

    elif "good morning" in Text:
        print("good morning")
        Speak("good morning jyoti mam")

    elif "good afternoon" in Text:
        print("good afternoon")
        Speak("good afternoon Jyoti mam")

    elif "good evening" in Text:
        print("good evening")
        Speak("good evening Jyoti mam")

    elif "good night" in Text:
        print("good night")
        Speak("good night Jyoti mam")

    elif "how are you" in Text:
        print("I am good")
        Speak("i am fantastic good Jyoti mam")

    elif "tell me about yourself" in Text:
        print("my name is jyoti and my author is jyoti rathore.so, jyoti rathore  is my Boss")
        Speak("my name is jyoti and My author is jyoti rathore.So, jyoti rathore is my Boss")
